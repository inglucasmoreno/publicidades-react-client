...
import { CartasDigitalesDetallesPage, CartasDigitalesPage } from "../cartasDigitales"
  ...
  return (
    <Layout>
      ...
      <Routes>
        ...
        <Route path="/carta-digital/detalles/:idCartaDigital" element={<CartasDigitalesDetallesPage />} />
